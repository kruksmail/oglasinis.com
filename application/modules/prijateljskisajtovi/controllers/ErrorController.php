...
class Prijateljskisajtovi_ErrorController extends Prijateljskisajtovi_Library_Controller_Action_Abstract {
	private $_notifier;
	private $_error;
	...
	public function init() {
		...
		$this->_notifier = new Custom_Service_Notifier_Error ( $environment, $error, $mailer, $session, $cookies, $_SERVER );
	...
	public function errorAction() {
		...
		switch ($this->_error->type) {
			...
			default :
				...
				$log = new Zend_Log ( new Zend_Log_Writer_Stream ( APP_PUBLIC . '/temp/prijateljskisajtoviException.log' ) );

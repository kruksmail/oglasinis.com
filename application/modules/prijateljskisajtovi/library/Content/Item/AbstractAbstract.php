...
abstract class Prijateljskisajtovi_Content_Item_AbstractAbstract {
	public $id;
	public $name;
	public $parent_id = 0;
	...
	public function __construct($page = null) {
		$this->_pageModel = new Oglas_Model_GlavniObjekat ();
		if (null != $page) {
	...
	public function loadPageObject($page) {
		...
		if ($row) {
			...
			$contentNode = new Oglas_Model_UdruzenjeContent ();
	...
	public function delete() {
		if (isset ( $this->id )) {
			...
			throw new Zend_Exception ( 'Nije moguce brisanje!' );
		}
	}
}
?>
<?php
class Users_Form_UserRegistrationAdmins extends Zend_Form
{
	public function init()
	{
		...
		$confirm = $this->createElement('select', 'confirm');
		$confirm->setLabel('Potvrda Email adrese:');
		$confirm->setRequired(TRUE);
		$confirm->addMultiOptions(array(
			'yes' => 'Potvrđena',
			'no' => 'Nepotvrđena'
		));

...
class Search_ErrorController extends Prijateljskisajtovi_Library_Controller_Action_Abstract {
	private $_notifier;
	private $_error;
	...
	public function errorAction() {
		...
		switch ($this->_error->type) {
			...
			default :
				...
				$log = new Zend_Log ( new Zend_Log_Writer_Stream ( APP_PUBLIC . '/temp/searchException.log' ) );
